<?php
namespace Module\Kapke\ClientData\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\Response;
use FOS\RestBundle\Controller\FOSRestController;
use FOS\RestBundle\View\View;
use Provider\Kapke\Clients\Entity\Client;

class ClientsController extends FOSRestController {
	public function getClientsAction () {
		$clients = $this->getDoctrine()->getRepository('Provider\\Kapke\\Clients\\Entity\\Client')->findAll();
	...
	public function deleteClientAction ($id) {
		$em = $this->getDoctrine()->getManager();
		$client = $this->getDoctrine()->getRepository('Provider\\Kapke\\Clients\\Entity\\Client')->find($id);
		$em->remove($client);
		$em->flush();
		$response = new Response();
